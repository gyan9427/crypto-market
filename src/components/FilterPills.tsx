...
function buildFilterPillsStyles(tokens: ThemeTokens) {
  ...
  return StyleSheet.create({
    ...
    pillActive: {
      backgroundColor: tokens.isDark ? ui.accentBg : c.primary[500],
      borderColor: tokens.isDark ? ui.accentBorder : c.primary[500],
    },
    pillText: {
    ...
    pillTextActive: {
      color: tokens.isDark ? MARKET_ACCENT : ui.filterPillActiveTextLight,
    },
  });
}
